# nvim-treesitter-queries-apex

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-apex/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-apex/actions/workflows/validate.yml)

Neovim tree-sitter queries for **apex**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-apex",
...
- [ ] Changes are scoped to `apex` — do not include files for other languages
